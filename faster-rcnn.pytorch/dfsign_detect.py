...
if __name__ == '__main__':
    ...
    load_name = os.path.join(input_dir, args.weight)
    ...
    tt100k_classes = np.asarray(['__background__',
    ...
    if args.net == 'vgg16':
        fasterRCNN = vgg16(tt100k_classes, pretrained=False,
                           class_agnostic=args.class_agnostic)
    elif args.net == 'res101':
        fasterRCNN = resnet(tt100k_classes, 101, pretrained=False,
                            class_agnostic=args.class_agnostic)
    elif args.net == 'res50':
        fasterRCNN = resnet(tt100k_classes, 50, pretrained=False,
                            class_agnostic=args.class_agnostic)
    elif args.net == 'res152':
        fasterRCNN = resnet(tt100k_classes, 152, pretrained=False,
                            class_agnostic=args.class_agnostic)
    else:
    ...
    while (num_images >= 0):
        ...
        if vis:
            im2show = np.copy(im)
        for j in xrange(1, len(tt100k_classes)):
            ...
            if inds.numel() > 0:
                ...
                if vis:
                    im2show = vis_detections(
                        im2show, tt100k_classes[j], cls_dets.numpy(), 0.5)
